...
public class Wedges {
	...
	static double tlsHalfSum_ru_v = 0;	// v = variance
	static double trsHalfSum_ru_v = 0;
	static double blsHalfSum_ru_v = 0;
	static double brsHalfSum_ru_v = 0;
	
	static double tlsHalfSum_rd_v = 0;
	static double trsHalfSum_rd_v = 0;
	static double blsHalfSum_rd_v = 0;
	static double brsHalfSum_rd_v = 0;
	
	/*** FV coordinates ***/
	static double mean_coord1 = 0, variance_coord1 = 0;
	static double mean_coord2 = 0, variance_coord2 = 0;
	static double mean_coord3 = 0, variance_coord3 = 0;
	static double mean_coord4 = 0, variance_coord4 = 0;
