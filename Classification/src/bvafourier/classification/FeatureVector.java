...
public class FeatureVector {
	...
	private static Image picture = new Image();
	ArrayList<ArrayList<Double>> Allfeatures;
	final static int BANDWIDTH = 2; // depth of a Ring (i.e. square) must be constant and a power two
	...
	public static ArrayList<Double> extractVector(Double[][] pic,int feature) {
...
//		System.out.println(ringFeatureVector.get(0));
